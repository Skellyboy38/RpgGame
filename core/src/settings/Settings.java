...
public class Settings {
	...
	public void addAnimationSheets(AssetManager manager) {
		...
		animationSheets.put(3, manager.get("monsterSheet3.png", Texture.class));
		animationSheets.put(4, manager.get("monsterSheet4.png", Texture.class));
		animationSheets.put(5, manager.get("flyingMonsterSheet1.png", Texture.class));
		animationSheets.put(6, manager.get("monsterSheet6.png", Texture.class));
		animationSheets.put(7, manager.get("monsterSheet7.png", Texture.class));
		animationSheets.put(8, manager.get("monsterSheet8.png", Texture.class));
		animationSheets.put(9, manager.get("monsterSheet9.png", Texture.class));
	...
	public void populateLevels() {
		levels.put(1, new Entity(2, 50, 10, 300, 2, animationSheets.get(9), false));
		levels.put(2, new Entity(2, 100, 10, 300, 2, animationSheets.get(2), false));
		levels.put(3, new Entity(2, 200, 10, 300, 2, animationSheets.get(3), false));
		levels.put(4, new Entity(2, 400, 10, 300, 2, animationSheets.get(4), false));
		levels.put(6, new Entity(2, 800, 10, 300, 3, animationSheets.get(6), false));
